...
import jiangxiaopeng.domain.identity.application.dto.UserInfoDto;
import jiangxiaopeng.domain.identity.application.service.UserApplicationService;
...
public class UserController {
    ...
    public ApiResponse<UserInfoDto> getCurrentUser(@AuthenticationPrincipal UserPrincipal user) {
        return ApiResponse.ok(userService.getCurrentUser(user.getUid()));
    }
    ...
    public ApiResponse<UserInfoDto> updateUser(
        ...
        return ApiResponse.ok(userService.updateUser(user.getUid(), request.username(), request.email()));
    }
    ...
    public ApiResponse<Map<String, Object>> changePassword(
        ...
        userService.changePassword(user.getUid(), request.oldPassword(), request.newPassword());

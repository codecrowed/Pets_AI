...
import jiangxiaopeng.domain.identity.application.command.LoginCommand;
import jiangxiaopeng.domain.identity.application.command.RefreshTokenCommand;
import jiangxiaopeng.domain.identity.application.command.RegisterCommand;
import jiangxiaopeng.domain.identity.application.dto.AuthResponse;
import jiangxiaopeng.domain.identity.application.service.AuthApplicationService;

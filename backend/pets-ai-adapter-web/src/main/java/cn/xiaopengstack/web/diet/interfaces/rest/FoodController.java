...
import jiangxiaopeng.domain.diet.application.dto.FoodDto;
import jiangxiaopeng.domain.diet.application.service.FoodService;
...
public class FoodController {
    ...
    public ApiResponse<List<FoodDto>> getFrequent(@AuthenticationPrincipal UserPrincipal user) {
        return ApiResponse.ok(foodService.getFrequentFoods(user.getUid()));
    }
}

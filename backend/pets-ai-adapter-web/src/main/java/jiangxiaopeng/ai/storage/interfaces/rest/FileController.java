...
import jiangxiaopeng.ai.storage.application.service.FileApplicationService;
...
public class FileController {
    ...
    public ApiResponse<FileUploadResponse> uploadFile(
        ...
        return ApiResponse.ok(fileService.uploadFile(user.getUserId(), file));
    }
    ...
    public ApiResponse<FileUploadResponse> getFileInfo(
        ...
        return ApiResponse.ok(fileService.getFileInfo(fileId, user.getUserId()));
    }
    ...
    public ResponseEntity<InputStreamResource> downloadFile(
            @AuthenticationPrincipal UserPrincipal user,
            @Parameter(description = "文件 ID") @PathVariable String fileId) {
        FileUploadResponse info = fileService.getFileInfo(fileId, user.getUserId());
        InputStream stream = fileService.downloadFile(fileId, user.getUserId());
